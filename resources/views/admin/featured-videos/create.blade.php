...
@section('title', 'Admin - Add Featured Video')
...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <div class="mb-6">
        ...
        <p class="text-gray-600 dark:!text-text-secondary mt-1" style="font-family: 'Poppins', sans-serif; font-weight: 400;">
            Add a YouTube link to be shown in the floating player
        </p>
    </div>

    <div class="bg-white dark:!bg-bg-card rounded-lg border border-gray-200 dark:!border-border-secondary p-8">
        <form action="{{ route('admin.featured-videos.store') }}" method="POST">
            @csrf
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (youtubeUrlInput) {
        ...
        // Initialize preview if there's already a value (from old input)
        updateVideoPreview();
    }
});
</script>
