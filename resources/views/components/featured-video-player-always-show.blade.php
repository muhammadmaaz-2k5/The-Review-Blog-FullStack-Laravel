@if(isset($randomFeaturedVideo) && $randomFeaturedVideo)
    ...
    @if($videoId)
    <div id="featured-video-container-always-show"
        ...
        <div class="bg-accent/90 backdrop-blur-sm text-white px-3 py-1 flex items-center justify-between text-xs font-bold">
            ...
            <button onclick="closeAlwaysShowFeaturedVideo()" class="hover:bg-accent-light p-1 rounded-full transition-colors">
        ...
        <div class="{{ $playerClass }} relative bg-black">
            <iframe
                id="featured-video-iframe-always-show"
                src="{{ $embedUrl }}"
    ...
    <script>
        function closeAlwaysShowFeaturedVideo() {
            const container = document.getElementById('featured-video-container-always-show');
            if (container) {
        ...
        // Log that this component is loaded and visible
        console.log('🎬 Featured Video Always-Show Component Loaded!');
        console.log('Video should be visible at bottom-left corner');
        console.log('Container ID: featured-video-container-always-show');
        
        // Make sure it's visible
        setTimeout(() => {
            const container = document.getElementById('featured-video-container-always-show');
            if (container) {
                console.log('✅ Container found and should be visible');
    ...
    <style>
        /* Force visibility */
        #featured-video-container-always-show {
        ...
        @media (max-width: 640px) {
            ...
            #featured-video-container-always-show.is-short {
                width: 140px; /* Even smaller for portrait video */
            }
            #featured-video-container-always-show.is-standard {
...
@else
    <script>
        console.log('❌ Featured Video Always-Show: No video available or variable not set');
    </script>
@endif