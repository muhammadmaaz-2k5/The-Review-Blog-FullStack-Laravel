        ...
        <div class="mb-8 bg-gradient-to-r from-blue-50 to-purple-50 dark:!from-blue-900/10 dark:!to-purple-900/10 rounded-lg border border-blue-200 dark:!border-blue-800 p-6">
            <div class="flex items-start justify-between">
                <div class="flex-1">
                    ...
                    <?php if($authorRequest): ?>
                        <?php if($authorRequest->isPending()): ?>
                            <div class="mt-4 p-4 bg-yellow-50 dark:!bg-yellow-900/10 border border-yellow-200 dark:!border-yellow-800 rounded-lg">
                                ...
                                <?php if($authorRequest->message): ?>
                                    <div class="mt-3 p-3 bg-white dark:!bg-bg-card rounded border border-yellow-200 dark:!border-yellow-800">
                                        ...
                                        <p class="text-sm text-gray-700 dark:!text-text-secondary" style="font-family: 'Poppins', sans-serif; font-weight: 400;"><?php echo e($authorRequest->message); ?></p>
                                    </div>
                                <?php endif; ?>
                                <p class="text-xs text-yellow-600 dark:!text-yellow-400 mt-2" style="font-family: 'Poppins', sans-serif; font-weight: 400;">
                                    Submitted on <?php echo e($authorRequest->created_at->format('F j, Y \a\t g:i A')); ?>

                                </p>
                            </div>
                        <?php elseif($authorRequest->isRejected()): ?>
                            <div class="mt-4 p-4 bg-red-50 dark:!bg-red-900/10 border border-red-200 dark:!border-red-800 rounded-lg">
                                ...
                                <?php if($authorRequest->admin_notes): ?>
                                    <div class="mt-3 p-3 bg-white dark:!bg-bg-card rounded border border-red-200 dark:!border-red-800">
                                        ...
                                        <p class="text-sm text-gray-700 dark:!text-text-secondary" style="font-family: 'Poppins', sans-serif; font-weight: 400;"><?php echo e($authorRequest->admin_notes); ?></p>
                                    </div>
                                <?php endif; ?>
                        ...
                        <?php endif; ?>
                    <?php else: ?>
                        <form method="POST" action="<?php echo e(route('user.request-author')); ?>" class="mt-4">
                            <?php echo csrf_field(); ?>
                            <div class="mb-4">
...
$message = $__bag->first($__errorArgs[0]); ?>
                                    <p class="mt-1 text-sm text-red-600 dark:!text-red-400" style="font-family: 'Poppins', sans-serif;"><?php echo e($message); ?></p>
                                <?php unset($message);
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\asdfq\Desktop\New folder (2)\resources\views/user/dashboard.blade.php ENDPATH**/ ?>