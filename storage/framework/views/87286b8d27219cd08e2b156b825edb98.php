...
<head>
    ...
    <!-- Ad Scripts -->
    <script src="https://quge5.com/88/tag.min.js" data-zone="238512" async data-cfasync="false"></script>
    <script>(function(s){s.dataset.zone='10895037',s.src='https://n6wxm.com/vignette.min.js'})([document.documentElement, document.body].filter(Boolean).pop().appendChild(document.createElement('script')))</script>
    <script>(function(s){s.dataset.zone='10895027',s.src='https://nap5k.com/tag.min.js'})([document.documentElement, document.body].filter(Boolean).pop().appendChild(document.createElement('script')))</script>
    ...
    <script
      ...
      data-clerk-publishable-key="<?php echo e(config('services.clerk.publishable_key')); ?>"
      src="<?php echo e(config('services.clerk.frontend_api_url')); ?>/npm/@clerk/clerk-js@latest/dist/clerk.browser.js"
    ...
    <script>
      window.addEventListener('load', async function () {
        ...
        const isLaravelAuthenticated = <?php echo e(auth()->check() ? 'true' : 'false'); ?>;
        
        if (Clerk.user && Clerk.session && !isLaravelAuthenticated) {
            // User is signed into Clerk but NOT Laravel -> Sync session
            try {
                const token = await Clerk.session.getToken();
                const email = Clerk.user.primaryEmailAddress ? Clerk.user.primaryEmailAddress.emailAddress : null;
                const name = Clerk.user.fullName || Clerk.user.firstName || 'User';
        ...
        } else if (!Clerk.user && isLaravelAuthenticated) {
...
<?php /**PATH C:\Users\asdfq\Desktop\New folder (2)\resources\views/layouts/app.blade.php ENDPATH**/ ?>