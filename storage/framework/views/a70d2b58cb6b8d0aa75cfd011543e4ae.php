...
<?php $__env->startSection('title', 'Create Article - Admin'); ?>
        ...
        <form action="<?php echo e(route('admin.articles.store')); ?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                <div class="lg:col-span-2 space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="excerpt" rows="3"
                                  class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-accent focus:border-transparent dark:!bg-bg-card-hover dark:!border-border-primary dark:!text-white"
                                  placeholder="Short description of the article"><?php echo e(old('excerpt')); ?></textarea>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="content" id="content" class="tinymce-editor w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-accent focus:border-transparent dark:!bg-bg-card-hover dark:!border-border-primary dark:!text-white"
                                  placeholder="Write your article content here..."><?php echo old('content'); ?></textarea>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" name="featured_image_alt" value="<?php echo e(old('featured_image_alt')); ?>"
                                   class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-accent focus:border-transparent dark:!bg-bg-card-hover dark:!border-border-primary dark:!text-white"
                        ...
                        <div>
                            ...
                            <input type="text" name="featured_image_title" value="<?php echo e(old('featured_image_title')); ?>"
                                   class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-accent focus:border-transparent dark:!bg-bg-card-hover dark:!border-border-primary dark:!text-white"
                    ...
                    <div class="bg-gray-50 dark:!bg-bg-card-hover p-4 rounded-lg border border-gray-200 dark:!border-border-primary">
                        ...
                        <div class="flex gap-4">
                            <div class="flex-1">
                                <input type="text" name="short_video_id" id="short_video_id" value="<?php echo e(old('short_video_id')); ?>"
                ...
                <div class="space-y-6">
                        ...
                        <select name="series_id" id="series_id"
                            ...
                            <?php if(isset($series)): ?>
                                <?php $__currentLoopData = $series; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ser): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($ser->id); ?>" <?php echo e(old('series_id') == $ser->id ? 'selected' : ''); ?>><?php echo e($ser->title); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <?php endif; ?>
                        </select>
                    ...
                    <!-- Series Order -->
                    <div id="series_order_field" class="<?php echo e(old('series_id') ? 'block' : 'hidden'); ?>">
                        <label class="block text-sm font-semibold text-gray-700 dark:!text-white mb-2" style="font-family: 'Poppins', sans-serif; font-weight: 600;">
                            Order in Series
                        </label>
                        <input type="number" name="series_order" value="<?php echo e(old('series_order', 1)); ?>" min="1"
                               class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-accent focus:border-transparent dark:!bg-bg-card-hover dark:!border-border-primary dark:!text-white"
                               placeholder="1">
                        ...
                        <div class="max-h-48 overflow-y-auto border border-gray-300 rounded-lg p-3 dark:!bg-bg-card-hover dark:!border-border-primary">
                            <?php $__currentLoopData = $tags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <label class="flex items-center gap-2 mb-2 cursor-pointer">
                                    <input type="checkbox" name="tags[]" value="<?php echo e($tag->id); ?>" <?php echo e(in_array($tag->id, old('tags', [])) ? 'checked' : ''); ?>
                    ...
                    <div class="space-y-3">
                        ...
                        <label class="flex items-center gap-2 cursor-pointer">
                            <input type="checkbox" name="allow_comments" value="1" <?php echo e(old('allow_comments', true) ? 'checked' : ''); ?>
                    ...
                    <?php if(config('services.facebook.enabled', false) || config('services.twitter.enabled', false) || config('services.instagram.enabled', false) || config('services.threads.enabled', false)): ?>
                    <div class="bg-blue-50 dark:!bg-blue-900/20 border border-blue-200 dark:!border-blue-800 rounded-lg p-4 mt-4">
                        ...
                        <?php if(config('services.facebook.enabled', false)): ?>
                        <label class="flex items-center gap-2 cursor-pointer bg-white dark:!bg-gray-800 px-3 py-2 rounded-lg border border-blue-200 dark:!border-blue-700 hover:bg-blue-50 dark:!hover:bg-blue-900/30 transition-colors">
                            <input type="checkbox" name="post_to_facebook" value="1" <?php echo e(old('post_to_facebook', old('status') === 'published' ? true : false) ? 'checked' : ''); ?>
                        ...
                        <?php endif; ?>
                        <?php if(config('services.twitter.enabled', false)): ?>
                        <label class="flex items-center gap-2 cursor-pointer bg-white dark:!bg-gray-800 px-3 py-2 rounded-lg border border-blue-200 dark:!border-blue-700 hover:bg-blue-50 dark:!hover:bg-blue-900/30 transition-colors">
                            <input type="checkbox" name="post_to_twitter" value="1" <?php echo e(old('post_to_twitter', false) ? 'checked' : ''); ?>
                        ...
                        <?php endif; ?>
                        <?php if(config('services.instagram.enabled', false)): ?>
                        <label class="flex items-center gap-2 cursor-pointer bg-white dark:!bg-gray-800 px-3 py-2 rounded-lg border border-blue-200 dark:!border-blue-700 hover:bg-blue-50 dark:!hover:bg-blue-900/30 transition-colors">
                            <input type="checkbox" name="post_to_instagram" value="1" <?php echo e(old('post_to_instagram', false) ? 'checked' : ''); ?>
                        ...
                        <?php endif; ?>
                        <?php if(config('services.threads.enabled', false)): ?>
                        <label class="flex items-center gap-2 cursor-pointer bg-white dark:!bg-gray-800 px-3 py-2 rounded-lg border border-blue-200 dark:!border-blue-700 hover:bg-blue-50 dark:!hover:bg-blue-900/30 transition-colors">
                            <input type="checkbox" name="post_to_threads" value="1" <?php echo e(old('post_to_threads', false) ? 'checked' : ''); ?>
...
async function scrapeUrl() {
    ...
    try {
        const response = await fetch('<?php echo e(route("admin.articles.scrape")); ?>', {
            method: 'POST',
            headers: {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\asdfq\Desktop\New folder (2)\resources\views/admin/articles/create.blade.php ENDPATH**/ ?>