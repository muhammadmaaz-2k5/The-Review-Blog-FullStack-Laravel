...
<div class="relative w-full h-[60vh] min-h-[500px] overflow-hidden">
    <div class="absolute inset-0 bg-gray-900">
        ...
        <?php else: ?>
            <div class="absolute inset-0 bg-cover bg-center transition-transform duration-[20s] hover:scale-105" 
                 style="background-image: url('<?php echo e(asset('article_image_notfound.png')); ?>');"></div>
        <?php endif; ?>
                            ...
                            <a href="<?php echo e(route('articles.show', $popular->slug)); ?>" class="flex gap-4 group">
                                <div class="w-20 h-28 flex-shrink-0 rounded-lg overflow-hidden bg-gray-200 relative">
                                    <?php if($popular->featured_image): ?>
                                        <img src="<?php echo e($popular->featured_image_url); ?>" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500" onerror="this.onerror=null;this.src='<?php echo e(asset('article_image_notfound.png')); ?>';">
                                    <?php else: ?>
                                        <img src="<?php echo e(asset('article_image_notfound.png')); ?>" class="w-full h-full object-cover">
                                    <?php endif; ?>
                        ...
                        <?php $__currentLoopData = $relatedSeries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $related): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <a href="<?php echo e(route('series.show', $related->slug)); ?>" class="group relative aspect-[2/1] rounded-xl overflow-hidden shadow-lg">
                                <?php if($related->featured_image): ?>
                                    ...
                                    ?>
                                    <img src="<?php echo e($relImg); ?>" class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" onerror="this.onerror=null;this.src='<?php echo e(asset('article_image_notfound.png')); ?>';">
                                <?php else: ?>
                                    <img src="<?php echo e(asset('article_image_notfound.png')); ?>" class="w-full h-full object-cover">
                                <?php endif; ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\asdfq\Desktop\Nazaarabox\resources\views/series/show.blade.php ENDPATH**/ ?>