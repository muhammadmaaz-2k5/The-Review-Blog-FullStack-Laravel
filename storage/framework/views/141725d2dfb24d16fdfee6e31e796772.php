<?php $__env->startSection('title', $category->name . ' - Nazaara Circle'); ?>
...
<div class="relative w-full h-[400px] md:h-[500px] overflow-hidden">
    ...
    <?php if($headerBackground): ?>
        <img src="<?php echo e($headerBackground); ?>" 
             alt="<?php echo e($category->name); ?>" 
             class="absolute inset-0 w-full h-full object-cover">
    <?php else: ?>
        <div class="absolute inset-0" style="<?php echo \Illuminate\Support\Arr::toCssStyles(['background: ' . $fallbackColor]) ?>"></div>
    ...
    <div class="relative z-10 h-full max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 flex flex-col justify-end pb-12 md:pb-16">
        ...
        <div aria-label="breadcrumb" class="flex items-center gap-3 text-xs font-bold tracking-widest uppercase text-gray-300 mb-8 bg-transparent" style="font-family: 'Poppins', sans-serif;">
            <a href="<?php echo e(route('home')); ?>" class="hover:text-accent transition-colors duration-300">Home</a>
            <span class="text-accent">/</span>
            <a href="<?php echo e(route('categories.index')); ?>" class="hover:text-accent transition-colors duration-300">Collections</a>
            <span class="text-accent">/</span>
            <span class="text-white border-b-2 border-accent pb-0.5"><?php echo e($category->name); ?></span>
        </div>
        ...
        <div class="flex flex-wrap gap-4 text-sm font-bold">
            <div class="flex items-center gap-2 bg-white/10 backdrop-blur-md px-5 py-2.5 rounded-full border border-white/20 text-white">
                ...
                <span><?php echo e(number_format($categoryStats['total_articles'])); ?> Stories</span>
            </div>
            <div class="flex items-center gap-2 bg-white/10 backdrop-blur-md px-5 py-2.5 rounded-full border border-white/20 text-white">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" /><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" /></svg>
                <span><?php echo e(number_format($categoryStats['total_views'])); ?> Views</span>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-10">
        ...
        <div class="lg:col-span-8">
            ...
            <div class="bg-white dark:!bg-bg-card border border-gray-200 dark:!border-border-secondary rounded-2xl p-6 mb-10 shadow-sm">
                <form method="GET" action="<?php echo e(route('categories.show', $category->slug)); ?>" class="flex flex-col md:flex-row gap-6 items-end">
                    <!-- Sort By -->
                    <div class="flex-1 w-full">
                        ...
                        <select name="sort" 
                            ...
                            <option value="latest" <?php echo e($filters['sort'] === 'latest' ? 'selected' : ''); ?>>Latest Updates</option>
            ...
            <?php if($articles->hasPages()): ?>
                <div class="text-center mt-16" id="load-more-container">
                    <button type="button" id="load-more-btn" 
                            ...
                            data-page="2" 
                            data-loading="false"
                            data-url="<?php echo e(route('categories.load-more', $category->slug)); ?>"
                            data-filters="<?php echo e(json_encode($filters)); ?>">
        ...
        <div class="lg:col-span-4 space-y-10">
            ...
            <div class="bg-white dark:!bg-bg-card rounded-2xl border border-gray-200 dark:!border-border-secondary overflow-hidden shadow-sm">
                ...
                <div class="p-6 space-y-4">
                    <div class="flex items-center justify-between pb-2 border-b border-gray-100 dark:!border-border-primary">
                        ...
                        <span class="text-lg font-black text-gray-900 dark:!text-white"><?php echo e(number_format($categoryStats['total_articles'])); ?></span>
                    </div>
                    <div class="flex items-center justify-between pb-2 border-b border-gray-100 dark:!border-border-primary">
                        <span class="text-sm text-gray-600 dark:!text-text-secondary font-medium uppercase tracking-wider">Total Views</span>
                        <span class="text-lg font-black text-gray-900 dark:!text-white"><?php echo e(number_format($categoryStats['total_views'])); ?></span>
                    </div>
                    ...
                    <div class="pt-2">
                        ...
                        <a href="<?php echo e(route('articles.show', $categoryStats['latest_article']->slug)); ?>" class="text-sm font-bold text-gray-900 dark:!text-white hover:text-accent transition-colors line-clamp-2">
                            <?php echo e($categoryStats['latest_article']->title); ?>
            ...
            <div class="bg-white dark:!bg-bg-card rounded-2xl border border-gray-200 dark:!border-border-secondary overflow-hidden shadow-sm">
                ...
                <div class="divide-y divide-gray-100 dark:!divide-border-primary">
                    <?php $__currentLoopData = $popularInCategory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $article): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="relative rounded-2xl overflow-hidden p-8 text-center group shadow-xl">
                ...
                <div class="relative z-10">
                    ...
                    <p class="text-white/90 text-sm mb-6 font-medium">Get the latest <?php echo e($category->name); ?> updates delivered straight to your inbox.</p>
            ...
            <div class="bg-white dark:!bg-bg-card rounded-2xl border border-gray-200 dark:!border-border-secondary p-6 shadow-sm">
                ...
                <div class="flex flex-wrap gap-2">
                    <?php $__currentLoopData = $categories->take(15); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <a href="<?php echo e(route('categories.show', $cat->slug)); ?>" 
                           class="px-4 py-2 text-xs font-bold rounded-lg border transition-all <?php echo e($cat->id === $category->id ? 'bg-accent text-white border-accent shadow-lg shadow-accent/30' : 'bg-gray-50 text-gray-700 border-gray-200 hover:border-accent hover:text-accent dark:!bg-bg-card-hover dark:!text-white dark:!border-border-primary dark:!hover:border-accent'); ?>">
                            <?php echo e($cat->name); ?>
    ...
    <div class="mt-20 relative rounded-3xl overflow-hidden">
        ...
        <div class="relative z-10 px-8 py-16 md:p-20 max-w-4xl">
            ...
            <div class="flex flex-wrap gap-4">
                <a href="<?php echo e(route('login')); ?>" class="px-8 py-3 bg-accent text-white font-bold rounded-full hover:bg-red-700 transition-all shadow-lg hover:shadow-accent/50">Join the Circle</a>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\asdfq\Desktop\New folder (2)\resources\views/categories/show.blade.php ENDPATH**/ ?>