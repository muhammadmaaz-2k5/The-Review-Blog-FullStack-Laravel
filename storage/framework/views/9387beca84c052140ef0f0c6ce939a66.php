<?php $__env->startSection('title', 'Contact Us - Nazaara Circle'); ?>
    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="content-card space-y-6">
            ...
            <section>
                ...
                <form action="<?php echo e(route('contact.store')); ?>" method="POST" class="space-y-4 opacity-60 pointer-events-none" style="position: relative;">
                    <?php echo csrf_field(); ?>
        ...
        <div class="who-we-are">
            ...
            <a href="<?php echo e(route('about')); ?>" class="who-btn">Read More About Us</a>
        </div>
    </div>
</div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\asdfq\Desktop\New folder (2)\resources\views/pages/contact.blade.php ENDPATH**/ ?>