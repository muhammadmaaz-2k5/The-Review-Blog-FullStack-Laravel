...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="bg-white dark:!bg-bg-card rounded-lg border border-gray-200 dark:!border-border-secondary p-6 mb-6">
        <div class="flex items-center justify-between mb-4">
            ...
            <div class="flex items-center gap-2">
                ...
                <?php if($facebookEnabled && $facebookPageId): ?>
        ...
        <form action="<?php echo e(route('admin.settings.facebook.update')); ?>" method="POST" id="facebookForm">
            <?php echo csrf_field(); ?>
            ...
            <div class="space-y-6">
                ...
                <div>
                    <label class="flex items-center gap-2 cursor-pointer">
                        <input type="checkbox" name="enabled" value="1" <?php echo e($facebookEnabled ? 'checked' : ''); ?>
                ...
                <div>
                    ...
                    <input type="text" name="page_id" value="<?php echo e(old('page_id', $facebookPageId)); ?>" required
                ...
                <div>
                    ...
                    <input type="password" name="page_access_token" value="<?php echo e(old('page_access_token')); ?>" 
                           placeholder="<?php echo e(config('services.facebook.page_access_token') ? '••••••••••••••••' : 'Enter your Facebook Page Access Token'); ?>"
                           <?php echo e(config('services.facebook.page_access_token') ? '' : 'required'); ?>
                ...
                <div>
                    ...
                    <input type="text" name="api_version" value="<?php echo e(old('api_version', $facebookApiVersion)); ?>"
                           class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-accent focus:border-transparent dark:!bg-bg-card-hover dark:!border-border-primary dark:!text-white"
                           placeholder="v18.0">
                    <p class="mt-1 text-xs text-gray-500 dark:!text-text-tertiary">
            ...
            <div class="flex gap-3 mt-8">
                ...
                <a href="<?php echo e(route('admin.dashboard')); ?>" class="px-6 py-2 bg-gray-100 hover:bg-gray-200 text-gray-900 rounded-lg transition-colors dark:!bg-bg-card dark:!text-white dark:!hover:bg-bg-card-hover" style="font-family: 'Poppins', sans-serif; font-weight: 600;">
                    Cancel
                </a>
            </div>
        </form>
    ...
    <div class="bg-white dark:!bg-bg-card rounded-lg border border-gray-200 dark:!border-border-secondary p-6 mb-6">
        <div class="flex items-center justify-between mb-4">
            ...
            <div class="flex items-center gap-2">
                ...
                <?php if($twitterEnabled && config('services.twitter.bearer_token')): ?>
        ...
        <form action="<?php echo e(route('admin.settings.twitter.update')); ?>" method="POST">
            <?php echo csrf_field(); ?>
            <div class="space-y-6">
                <div>
                    <label class="flex items-center gap-2 cursor-pointer">
                        <input type="checkbox" name="enabled" value="1" <?php echo e($twitterEnabled ? 'checked' : ''); ?>
                ...
                <div>
                    ...
                    <input type="password" name="bearer_token" value="<?php echo e(old('bearer_token')); ?>" 
                           placeholder="<?php echo e(config('services.twitter.bearer_token') ? '••••••••••••••••' : 'Enter your Twitter Bearer Token'); ?>"
                           <?php echo e(config('services.twitter.bearer_token') ? '' : 'required'); ?>
                ...
                <div>
                    ...
                    <input type="text" name="api_version" value="<?php echo e(old('api_version', $twitterApiVersion)); ?>"
                           class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-accent focus:border-transparent dark:!bg-bg-card-hover dark:!border-border-primary dark:!text-white"
                           placeholder="2">
                </div>
            </div>
    ...
    <div class="bg-white dark:!bg-bg-card rounded-lg border border-gray-200 dark:!border-border-secondary p-6 mb-6">
        <div class="flex items-center justify-between mb-4">
            ...
            <div class="flex items-center gap-2">
                <span class="text-sm text-gray-600 dark:!text-text-secondary" style="font-family: 'Poppins', sans-serif; font-weight: 400;">Status:</span>
                <?php if($instagramEnabled && $instagramPageId): ?>
                    <span class="px-3 py-1 bg-green-100 text-green-800 rounded-full text-xs font-semibold dark:!bg-green-900/20 dark:!text-green-400">Active</span>
                <?php else: ?>
                    <span class="px-3 py-1 bg-gray-100 text-gray-800 rounded-full text-xs font-semibold dark:!bg-gray-800 dark:!text-gray-400">Inactive</span>
                <?php endif; ?>
        ...
        <form action="<?php echo e(route('admin.settings.instagram.update')); ?>" method="POST">
            <?php echo csrf_field(); ?>
            <div class="space-y-6">
                <div>
                    <label class="flex items-center gap-2 cursor-pointer">
                        <input type="checkbox" name="enabled" value="1" <?php echo e($instagramEnabled ? 'checked' : ''); ?>
                ...
                <div>
                    ...
                    <input type="text" name="page_id" value="<?php echo e(old('page_id', $instagramPageId)); ?>" required
                           class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-accent focus:border-transparent dark:!bg-bg-card-hover dark:!border-border-primary dark:!text-white"
                           placeholder="e.g., 123456789012345">
                </div>
                <div>
                    ...
                    <input type="password" name="access_token" value="<?php echo e(old('access_token')); ?>" 
                           placeholder="<?php echo e(config('services.instagram.access_token') ? '••••••••••••••••' : 'Enter your Instagram Access Token'); ?>"
                           <?php echo e(config('services.instagram.access_token') ? '' : 'required'); ?>
                ...
                <div>
                    ...
                    <input type="text" name="api_version" value="<?php echo e(old('api_version', $instagramApiVersion)); ?>"
                           class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-accent focus:border-transparent dark:!bg-bg-card-hover dark:!border-border-primary dark:!text-white"
                           placeholder="v18.0">
                </div>
            </div>
    ...
    <div class="bg-white dark:!bg-bg-card rounded-lg border border-gray-200 dark:!border-border-secondary p-6 mb-6">
        <div class="flex items-center justify-between mb-4">
            ...
            <div class="flex items-center gap-2">
                <span class="text-sm text-gray-600 dark:!text-text-secondary" style="font-family: 'Poppins', sans-serif; font-weight: 400;">Status:</span>
                <?php if($threadsEnabled && $threadsPageId): ?>
                    <span class="px-3 py-1 bg-green-100 text-green-800 rounded-full text-xs font-semibold dark:!bg-green-900/20 dark:!text-green-400">Active</span>
                <?php else: ?>
                    <span class="px-3 py-1 bg-gray-100 text-gray-800 rounded-full text-xs font-semibold dark:!bg-gray-800 dark:!text-gray-400">Inactive</span>
                <?php endif; ?>
        ...
        <form action="<?php echo e(route('admin.settings.threads.update')); ?>" method="POST">
            <?php echo csrf_field(); ?>
            <div class="space-y-6">
                <div>
                    <label class="flex items-center gap-2 cursor-pointer">
                        <input type="checkbox" name="enabled" value="1" <?php echo e($threadsEnabled ? 'checked' : ''); ?>
                ...
                <div>
                    ...
                    <input type="text" name="page_id" value="<?php echo e(old('page_id', $threadsPageId)); ?>" required
                           class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-accent focus:border-transparent dark:!bg-bg-card-hover dark:!border-border-primary dark:!text-white"
                           placeholder="e.g., 123456789012345">
                </div>
                <div>
                    ...
                    <input type="password" name="access_token" value="<?php echo e(old('access_token')); ?>" 
                           placeholder="<?php echo e(config('services.threads.access_token') ? '••••••••••••••••' : 'Enter your Threads Access Token'); ?>"
                           <?php echo e(config('services.threads.access_token') ? '' : 'required'); ?>
                ...
                <div>
                    ...
                    <input type="text" name="api_version" value="<?php echo e(old('api_version', $threadsApiVersion)); ?>"
                           class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-accent focus:border-transparent dark:!bg-bg-card-hover dark:!border-border-primary dark:!text-white"
                           placeholder="v18.0">
                </div>
            </div>
...
function testConnection(platform, button = null) {
    ...
    const routes = {
        'facebook': '<?php echo e(route("admin.settings.facebook.test")); ?>',
        'twitter': '<?php echo e(route("admin.settings.twitter.test")); ?>',
        'instagram': '<?php echo e(route("admin.settings.instagram.test")); ?>',
        'threads': '<?php echo e(route("admin.settings.threads.test")); ?>',
    };
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\asdfq\Desktop\Nazaarabox\resources\views/admin/settings/index.blade.php ENDPATH**/ ?>